...
namespace Application\Block\FedFeaturedSolution;
...
class Controller extends BlockController
{
    ...
    protected $btTable = 'btFeaturedSolution';
    ...
    {
        return t("Featured content with background image, logo, and blurb.");
    }

    public function getBlockTypeName()
    {
        return t("Featured Solution - FedResults");
    }
