...
namespace Application\Block\FedVendorContactInfo;
...
class Controller extends BlockController
{
    ...
    protected $btTable = 'btFedVendorContactInfo';
    ...
    {
        return t("Contact info module for Vendors: name, phone numbers, email, etc.");
    }

    public function getBlockTypeName()
    {
        return t("Vendor Contact Info - FedResults");
    }

    public function view()
    {
        $this->set('vendorTitle', $this->getVendorTitle());
        $this->set('vendorSolutionTitle', $this->getVendorSolutionTitle());
    ...
    {
        return isset($this->vendorTitle) ? $this->vendorTitle : null;
    }

    public function getVendorSolutionTitle()
    {
        return isset($this->vendorSolutionTitle) ? $this->vendorSolutionTitle : null;
    }
